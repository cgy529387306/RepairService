 ...
 */
public class AccountCenterAdapter extends BaseQuickAdapter<SettlementCenterData, BaseViewHolder> {

    public AccountCenterAdapter() {
        super(R.layout.item_account_center, new ArrayList<>());
    }
    @Override
    protected void convert(BaseViewHolder helper, SettlementCenterData item) {
